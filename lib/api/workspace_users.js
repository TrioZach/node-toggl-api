...
TogglClient.prototype.deleteWorkspaceUser = function deleteWorkspaceUser(wuId,
  ...
  this.apiRequest('/api/v9/workspaces/' + this.options.workspaceId + '/users/' + wuId, req, callback);
};
...
TogglClient.prototype.updateWorkspaceUser = function updateWorkspaceUser(wuId,
  ...
  this.apiRequest('/api/v9/workspaces/' + this.options.workspaceId + '/users/' + wuId, req,
