...
TogglClient.prototype.createTask = function createTask(name, projectId, data,
  ...
  this.apiRequest('/api/v9/workspaces/' + this.options.workspaceId + '/tasks', req, utils.wrapDataCallback(callback));
};
...
TogglClient.prototype.deleteTask = function deleteTask(taskId, callback) {
  ...
  this.apiRequest('/api/v9/workspaces/' + this.options.workspaceId + '/tasks/' + taskId, req, callback);
};
...
TogglClient.prototype.getTaskData = function getTaskData(taskId, callback) {
  this.apiRequest('/api/v9/workspaces/' + this.options.workspaceId + '/tasks/' + taskId, {},
...
TogglClient.prototype.updateTask = function updateTask(taskId, data, fields,
  ...
  this.apiRequest('/api/v9/workspaces/' + this.options.workspaceId + '/tasks/' + taskId, req,
    utils.wrapDataCallback(callback));
};
