...
TogglClient.prototype.addProjectUser = function addProjectUser(projectId,
  ...
  this.apiRequest('/api/v9/workspaces/' + this.options.workspaceId + '/project_users', req,
...
TogglClient.prototype.deleteProjectUser = function deleteProjectUser(puID,
  ...
  this.apiRequest('/api/v9/workspaces/' + this.options.workspaceId + '/project_users/' + puID, req, callback);
};
...
TogglClient.prototype.updateProjectUser = function updateProjectUser(puID,
  ...
  this.apiRequest('/api/v9/workspaces/' + this.options.workspaceId + '/project_users/' + puID, req,
    utils.wrapDataCallback(callback));
};
