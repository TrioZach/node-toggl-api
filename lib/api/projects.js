...
TogglClient.prototype.createProject = function createProject(data, callback) {
  ...
  this.apiRequest('/api/v9/workspaces/' + this.options.workspaceId + '/projects/', req, utils.wrapDataCallback(callback));
};
...
TogglClient.prototype.deleteProject = function deleteProject(projectId,
  ...
  this.apiRequest('/api/v9/workspaces/' + this.options.workspaceId + '/projects/' + projectId, req, callback);
};
...
TogglClient.prototype.getProjectData = function getProjectData(projectId,
  callback) {
  this.apiRequest('/api/v9/workspaces/' + this.options.workspaceId + '/projects/' + projectId, {},
...
TogglClient.prototype.getProjectTasks = function getProjectTasks(projectId,
  callback) {
  this.apiRequest('/api/v9/workspaces/' + this.options.workspaceId + '/projects/' + projectId + '/tasks', {}, callback);
};
...
TogglClient.prototype.getProjectUsers = function getProjectUsers(projectId,
  callback) {
  this.apiRequest('/api/v9/workspaces/' + this.options.workspaceId + '/projects/' + projectId + '/project_users', {}, callback);
};
...
TogglClient.prototype.updateProject = function updateProject(projectId, data,
  ...
  this.apiRequest('/api/v9/workspaces/' + this.options.workspaceId + '/projects/' + projectId, req,
    utils.wrapDataCallback(callback));
};
