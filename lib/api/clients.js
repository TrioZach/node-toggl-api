...
TogglClient.prototype.createClient = function createClient(data, callback) {
  ...
  this.apiRequest('/api/v9/workspaces/' + this.options.workspaceId + '/clients', req, utils.wrapDataCallback(callback));
};
...
TogglClient.prototype.deleteClient = function deleteClient(clientId, callback) {
  ...
  this.apiRequest('/api/v9/workspaces/' + this.options.workspaceId + '/clients/' + clientId, req, callback);
};
...
TogglClient.prototype.getClientData = function getClientData(clientId,
  callback) {
  this.apiRequest('/api/v9/workspaces/' + this.options.workspaceId + '/clients/' + clientId, {},
...
TogglClient.prototype.getClientProjects = function getClientProjects(clientId,
  ...
  this.apiRequest('/api/v9/workspaces/' + this.options.workspaceId + '/projects', { ...qs, client_ids: [clientId] },
    callback);
};
...
TogglClient.prototype.getClients = function getClients(callback) {
  this.apiRequest('/api/v9/workspaces/' + this.options.workspaceId + '/clients', {}, callback);
};
...
TogglClient.prototype.updateClient = function updateClient(clientId, data,
  ...
  this.apiRequest('/api/v9/workspaces/' + this.options.workspaceId + '/clients/' + clientId, req,
    utils.wrapDataCallback(callback));
};
