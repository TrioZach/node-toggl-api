...
TogglClient.prototype.createTag = function createTag(name, workspaceId,
  ...
  this.apiRequest('/api/v9/workspaces/' + this.options.workspaceId + '/tags/', req, utils.wrapDataCallback(callback));
};
...
TogglClient.prototype.deleteTag = function deleteTag(tagId, callback) {
  ...
  this.apiRequest('/api/v9/workspaces/' + this.options.workspaceId + '/tags/' + tagId, req, callback);
};
...
TogglClient.prototype.updateTagName = function updateTagName(tagId, name,
  ...
  this.apiRequest('/api/v9/workspaces/' + this.options.workspaceId + '/tags/' + tagId, req,
